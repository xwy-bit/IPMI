...
class MainUI(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.i0 = ipmi('0.0.0.0','ADMIN','passwd')
        self.i1 = ipmi('0.0.0.0','ADMIN','passwd')
        self.i2 = ipmi('0.0.0.0','ADMIN','passwd')
        self.i3 = ipmi('0.0.0.0','ADMIN','passwd')
        self.i4 = ipmi('0.0.0.0','ADMIN','passwd')
        self.i0.establish()
        self.i1.establish()
        self.i2.establish()
        self.i3.establish()
